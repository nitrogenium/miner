...
# mkdir -p miners/20/nv
# mkdir -p miners/20/amd
...
# wget https://github.com/tontechio/pow-miner-gpu/releases/download/$version/minertools-cuda-ubuntu-20.04-x86-64.tar.gz -P miners
...
# wget https://github.com/tontechio/pow-miner-gpu/releases/download/$version/minertools-opencl-ubuntu-20.04-x86-64.tar.gz -P miners
